...
public class GazTigrGLEntity extends CamoVehicleBase {
    ...
    private static final EntityDataAccessor<Float> STEERING_ANGLE = SynchedEntityData.defineId(GazTigrGLEntity.class, EntityDataSerializers.FLOAT);

    private float prevSteeringAngle = 0f;
    private float wheelRotation = 0f;
    private float prevWheelRotation = 0f;

    public GazTigrGLEntity(EntityType<GazTigrGLEntity> type, Level world) {
        super(type, world);
    }
