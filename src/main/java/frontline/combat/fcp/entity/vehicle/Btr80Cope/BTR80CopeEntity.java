package frontline.combat.fcp.entity.vehicle.Btr80Cope;
...
public class BTR80CopeEntity extends CamoVehicleBase {
    ...
    private static final EntityDataAccessor<Float> STEERING_ANGLE = SynchedEntityData.defineId(BTR80CopeEntity.class, EntityDataSerializers.FLOAT);
    ...
    public BTR80CopeEntity(EntityType<BTR80CopeEntity> type, Level world) {super(type, world);}
