...
public class MATVTOWEntity extends CamoVehicleBase {
    ...
    private static final EntityDataAccessor<Float> STEERING_ANGLE = SynchedEntityData.defineId(MATVTOWEntity.class, EntityDataSerializers.FLOAT);
    ...
    public MATVTOWEntity(EntityType<MATVTOWEntity> type, Level world) {super(type, world);}
