...
public class StrykerMk19Entity extends CamoVehicleBase {
    ...
    private static final EntityDataAccessor<Float> STEERING_ANGLE = SynchedEntityData.defineId(StrykerMk19Entity.class, EntityDataSerializers.FLOAT);
    private float prevSteeringAngle = 0f, wheelRotation = 0f, prevWheelRotation = 0f;

    public StrykerMk19Entity(EntityType<StrykerMk19Entity> type, Level world) { super(type, world); }
