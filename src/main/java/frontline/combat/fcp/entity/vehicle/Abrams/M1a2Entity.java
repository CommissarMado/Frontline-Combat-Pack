...
public class M1a2Entity extends CamoVehicleBase {
    ...
    private static final EntityDataAccessor<Float> STEERING_ANGLE = SynchedEntityData.defineId(M1a2Entity.class, EntityDataSerializers.FLOAT);
    ...
    public M1a2Entity(EntityType<M1a2Entity> type, Level world) {super(type, world);}
