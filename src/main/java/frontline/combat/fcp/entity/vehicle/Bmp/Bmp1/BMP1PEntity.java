...
public class BMP1PEntity extends CamoVehicleBase {
    ...
    private static final EntityDataAccessor<Float> STEERING_ANGLE = SynchedEntityData.defineId(BMP1PEntity.class, EntityDataSerializers.FLOAT);
    ...
    public BMP1PEntity(EntityType<BMP1PEntity> type, Level world) {super(type, world);}
