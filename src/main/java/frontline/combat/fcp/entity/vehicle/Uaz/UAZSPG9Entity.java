...
public class UAZSPG9Entity extends CamoVehicleBase {
    ...
    private static final EntityDataAccessor<Float> STEERING_ANGLE = SynchedEntityData.defineId(UAZSPG9Entity.class, EntityDataSerializers.FLOAT);
    ...
    public UAZSPG9Entity(EntityType<UAZSPG9Entity> type, Level world) {super(type, world);}
