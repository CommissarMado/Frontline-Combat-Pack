...
public class GazTigrMGEntity extends CamoVehicleBase {
    ...
    private static final EntityDataAccessor<Float> STEERING_ANGLE = SynchedEntityData.defineId(GazTigrMGEntity.class, EntityDataSerializers.FLOAT);

    private float prevSteeringAngle = 0f;
    private float wheelRotation = 0f;
    private float prevWheelRotation = 0f;

    public GazTigrMGEntity(EntityType<GazTigrMGEntity> type, Level world) {
        super(type, world);
    }
