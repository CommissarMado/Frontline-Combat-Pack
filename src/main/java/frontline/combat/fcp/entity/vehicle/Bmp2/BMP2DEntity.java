...
public class BMP2DEntity extends CamoVehicleBase {
    ...
    private static final EntityDataAccessor<Float> STEERING_ANGLE = SynchedEntityData.defineId(BMP2DEntity.class, EntityDataSerializers.FLOAT);
    ...
    public BMP2DEntity(EntityType<BMP2DEntity> type, Level world) {super(type, world);}
