package frontline.combat.fcp.entity.vehicle.Btr82Cope;
...
public class BTR82CopeEntity extends CamoVehicleBase {
    ...
    private static final EntityDataAccessor<Float> STEERING_ANGLE = SynchedEntityData.defineId(BTR82CopeEntity.class, EntityDataSerializers.FLOAT);
    ...
    public BTR82CopeEntity(EntityType<BTR82CopeEntity> type, Level world) {super(type, world);}
