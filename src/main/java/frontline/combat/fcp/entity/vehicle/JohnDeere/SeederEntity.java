...
public class SeederEntity extends CamoVehicleBase {
    ...
    private static final EntityDataAccessor<Float> STEERING_ANGLE = SynchedEntityData.defineId(SeederEntity.class, EntityDataSerializers.FLOAT);
    ...
    public SeederEntity(EntityType<SeederEntity> type, Level world) {super(type, world);}
