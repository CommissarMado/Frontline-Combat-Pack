package frontline.combat.fcp.entity.vehicle.Bmp.Bmp1;
...
public class BMP1UEntity extends CamoVehicleBase {
    ...
    private static final EntityDataAccessor<Float> STEERING_ANGLE = SynchedEntityData.defineId(BMP1UEntity.class, EntityDataSerializers.FLOAT);
    ...
    public BMP1UEntity(EntityType<BMP1UEntity> type, Level world) {super(type, world);}
