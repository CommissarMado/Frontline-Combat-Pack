...
public class UAZ3303Entity extends CamoVehicleBase {
    ...
    private static final EntityDataAccessor<Float> STEERING_ANGLE = SynchedEntityData.defineId(UAZ3303Entity.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Boolean> TENT = SynchedEntityData.defineId(UAZ3303Entity.class, EntityDataSerializers.BOOLEAN);
    ...
    public UAZ3303Entity(EntityType<UAZ3303Entity> type, Level world) {super(type, world);}
