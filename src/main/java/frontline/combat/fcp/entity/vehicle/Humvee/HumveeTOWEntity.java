...
public class HumveeTOWEntity extends CamoVehicleBase {
    ...
    private static final EntityDataAccessor<Float> STEERING_ANGLE = SynchedEntityData.defineId(HumveeTOWEntity.class, EntityDataSerializers.FLOAT);
    ...
    public HumveeTOWEntity(EntityType<HumveeTOWEntity> type, Level world) {super(type, world);}
