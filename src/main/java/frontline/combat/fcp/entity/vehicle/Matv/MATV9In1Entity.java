...
public class MATV9In1Entity extends CamoVehicleBase {
    ...
    private static final EntityDataAccessor<Float> STEERING_ANGLE = SynchedEntityData.defineId(MATV9In1Entity.class, EntityDataSerializers.FLOAT);
    ...
    public MATV9In1Entity(EntityType<MATV9In1Entity> type, Level world) {super(type, world);}
