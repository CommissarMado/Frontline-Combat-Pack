package frontline.combat.fcp.entity.vehicle.T80bvm;
...
public class T80BVMEntity extends CamoVehicleBase {

    private static final ResourceLocation[] CAMO_TEXTURES = {
            new ResourceLocation("fcp", "textures/entity/t80bvm/t80bvm.png")
    };

    private static final String[] CAMO_NAMES = {"Flag", "No-Flag"};

    private static final EntityDataAccessor<Float> STEERING_ANGLE = SynchedEntityData.defineId(T80BVMEntity.class, EntityDataSerializers.FLOAT);
    ...
    public T80BVMEntity(EntityType<T80BVMEntity> type, Level world) {super(type, world);}
