...
public class UAZ452Entity extends CamoVehicleBase {
    ...
    private static final EntityDataAccessor<Float> STEERING_ANGLE = SynchedEntityData.defineId(UAZ452Entity.class, EntityDataSerializers.FLOAT);
    ...
    public UAZ452Entity(EntityType<UAZ452Entity> type, Level world) {super(type, world);}
