package frontline.combat.fcp.entity.vehicle.Bmp2Noatgm;
...
public class BMP2NoAtgmEntity extends CamoVehicleBase {
    ...
    private static final EntityDataAccessor<Float> STEERING_ANGLE = SynchedEntityData.defineId(BMP2NoAtgmEntity.class, EntityDataSerializers.FLOAT);
    ...
    public BMP2NoAtgmEntity(EntityType<BMP2NoAtgmEntity> type, Level world) {super(type, world);}
