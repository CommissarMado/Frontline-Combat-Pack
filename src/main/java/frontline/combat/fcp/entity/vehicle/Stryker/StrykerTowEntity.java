...
public class StrykerTowEntity extends CamoVehicleBase {
    ...
    private static final EntityDataAccessor<Float> STEERING_ANGLE = SynchedEntityData.defineId(StrykerTowEntity.class, EntityDataSerializers.FLOAT);
    private float prevSteeringAngle = 0f, wheelRotation = 0f, prevWheelRotation = 0f;

    public StrykerTowEntity(EntityType<StrykerTowEntity> type, Level world) { super(type, world); }
