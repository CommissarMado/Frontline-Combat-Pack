package frontline.combat.fcp.entity.vehicle.NovatorUnarmed;
...
public class NovatorUnarmedEntity extends CamoVehicleBase {
    ...
    private static final EntityDataAccessor<Float> STEERING_ANGLE = SynchedEntityData.defineId(NovatorUnarmedEntity.class, EntityDataSerializers.FLOAT);
    ...
    public NovatorUnarmedEntity(EntityType<NovatorUnarmedEntity> type, Level world) {super(type, world);}
