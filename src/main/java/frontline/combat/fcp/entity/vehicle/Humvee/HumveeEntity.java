...
public class HumveeEntity extends CamoVehicleBase {
    ...
    private static final EntityDataAccessor<Float> STEERING_ANGLE = SynchedEntityData.defineId(HumveeEntity.class, EntityDataSerializers.FLOAT);
    ...
    public HumveeEntity(EntityType<HumveeEntity> type, Level world) {super(type, world);}
