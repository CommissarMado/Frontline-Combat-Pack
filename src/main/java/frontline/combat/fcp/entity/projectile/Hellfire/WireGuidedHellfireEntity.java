...
public class WireGuidedHellfireEntity  extends MissileProjectile implements GeoEntity {
    ...
    private PlayState movementPredicate(AnimationState<WireGuidedHellfireEntity> event) {
