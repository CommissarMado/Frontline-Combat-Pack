package frontline.combat.fcp.entity.projectile.Sidewinder;
...
public class SidewinderEntity extends MissileProjectile implements GeoEntity {
    ...
    private PlayState movementPredicate(AnimationState<SidewinderEntity> event) {
