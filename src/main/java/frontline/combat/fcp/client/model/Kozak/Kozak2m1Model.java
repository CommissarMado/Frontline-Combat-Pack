...
public class Kozak2m1Model extends FCPVehicleModel<Kozak2m1Entity> {
    ...
    @Override public @Nullable VehicleModel.TransformContext<Kozak2m1Entity> collectTransform(String boneName) {
        VehicleModel.TransformContext<Kozak2m1Entity> steer = WheelRotationTransforms.matchAnyTurn(boneName, 0.43, 30f, "whell", "whell2");
        if (steer != null) return steer;
        VehicleModel.TransformContext<Kozak2m1Entity> wheels = WheelRotationTransforms.matchAny(boneName, 0.43, "whell3", "whell4");
