...
public class BTR80CopeModel extends FCPVehicleModel<BTR80CopeEntity> {

    @Override
    public ResourceLocation getModelResource(BTR80CopeEntity animatable) {
        return new ResourceLocation(FCP.MODID, "geo/btr80_cope.geo.json");
    }
    ...
    @Override
    public @Nullable VehicleModel.TransformContext<BTR80CopeEntity> collectTransform(String boneName) {
