...
public class Ch53eModel extends VehicleModel<Ch53eEntity> {

    @Override
    public ResourceLocation getModelResource(Ch53eEntity animatable) {
        return new ResourceLocation(FCP.MODID, "geo/ch53e.geo.json");
    }

    @Override
    public @Nullable VehicleModel.TransformContext<Ch53eEntity> collectTransform(String boneName) {
