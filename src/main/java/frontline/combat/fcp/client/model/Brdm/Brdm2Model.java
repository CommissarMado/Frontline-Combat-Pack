...
public class Brdm2Model extends FCPVehicleModel<Brdm2Entity> {
    ...
    @Override public @Nullable VehicleModel.TransformContext<Brdm2Entity> collectTransform(String boneName) {
        VehicleModel.TransformContext<Brdm2Entity> steer = WheelRotationTransforms.matchAnyTurn(boneName, 0.6, 30f, "WheelTurnR1", "WheelTurnR4");
        if (steer != null) return steer;
        VehicleModel.TransformContext<Brdm2Entity> wheels = WheelRotationTransforms.matchAny(boneName, 0.6, "WheelTurnR2", "WheelTurnR3");
