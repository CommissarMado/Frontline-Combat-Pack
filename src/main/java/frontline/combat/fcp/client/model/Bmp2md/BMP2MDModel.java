package frontline.combat.fcp.client.model.Bmp2md;
...
/**
 * BMP-2MD shares the no-ATGM BMP-2 skeleton exactly: its geo was renamed to the
 * standard SBW bone names (turret / barrel / BarrelOccilator / wheelL#/wheelR#) and the
 * static GUS track links were replaced with the base BMP animated track subtree
 * (TrackL/R + trackMov/trackRot L/R 0-49), so this model is identical to the base BMP-2
 * model - including the 50-frame track path below, which drives those bones.
 */
