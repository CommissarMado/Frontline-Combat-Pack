package frontline.combat.fcp.client.model.Bmp2Noatgm;
...
public class BMP2NoAtgmModel extends FCPVehicleModel<BMP2NoAtgmEntity> {
    ...
    @Override
    public @Nullable VehicleModel.TransformContext<BMP2NoAtgmEntity> collectTransform(String boneName) {
    ...
    private VehicleModel.TransformContext<BMP2NoAtgmEntity> barrelRecoil(int barrelIndex) {
