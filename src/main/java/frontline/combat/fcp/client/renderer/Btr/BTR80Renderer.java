...
import frontline.combat.fcp.client.model.Btr.BTR80Model;
...
public class BTR80Renderer extends VehicleRenderer<BTR80Entity> {
    ...
    @Override public ResourceLocation getTextureLocation(BTR80Entity e) { return FcpVehicleTexture.resolve(e, e.getCurrentTexture()); }
}
